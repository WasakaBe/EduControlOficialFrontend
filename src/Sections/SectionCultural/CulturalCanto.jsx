...
import { logomusical } from '../../Image'
export default function CulturalCanto() {
  return (
    <div>
      <Navbar/>
      <Breadcrumbs path={'Seccion de Canto'}/>
      <div className='container-cultural'>
            <h2>Seccion de Canto</h2>
            <div className='info-text-img'>
                <img src={logomusical} alt='futbol'/>
