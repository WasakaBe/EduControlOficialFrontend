...
import { logobasketball } from '../../Image'
export default function CulturalBasketball() {
  return (
    <div>
      <Navbar/>
      <Breadcrumbs path={'Seccion de Basquetbol'}/>
      <div className='container-cultural'>
            <h2>Seccion de Basquetbol</h2>
            <div className='info-text-img'>
                <img src={logobasketball} alt='futbol'/>
